    ...
    <b-navbar toggleable="lg" type="dark" variant="dark">
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto mr-5">
          ...
          <b-nav-item :to="{ name: 'sponsors' }" :disabled="!isUserLoggedIn">PATROCINADORES</b-nav-item>
          <b-nav-item :to="{ name: 'experts' }" :disabled="!isUserLoggedIn">ESPECIALISTAS</b-nav-item>
          <b-nav-item to="#contacts">CONTACTOS</b-nav-item>
          <div v-if="isUserLoggedIn">
            <div v-if="getUserType === 'user'">
              <b-nav-item :to="{ name: 'profile' }">
                <img class="avatar" :src="require(`@/assets/avatars/${this.getUserLevelByPoints(
